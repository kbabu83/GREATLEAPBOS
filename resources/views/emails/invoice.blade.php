...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This is your subscription invoice for {{ $plan->name }}. Please review the details below and make the payment by the due date to avoid service interruptions.</p>
            ...
            <div class="invoice-details">
                ...
                <div class="detail-group">
                    ...
                    <div class="detail-value">{{ $invoice->billing_period_start->format('M d') }} - {{ $invoice->billing_period_end->format('M d, Y') }}</div>
                </div>
                <div class="detail-group">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>{{ $plan->name }} ({{ ucfirst($invoice->subscription->billing_cycle) }})</td>
            ...
            @if ($invoice->status !== 'paid')
                <center>
                    <a href="{{ config('app.frontend_url') }}/tenant/invoices/{{ $invoice->id }}" class="payment-button">Pay Invoice Now</a>
                </center>
