    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="success-box">
                ...
                Your payment was successfully processed on {{ now()->format('M d, Y') }}
            </div>
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ ucfirst($invoice->subscription->billing_cycle) }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Billing Period</span>
                    <span class="detail-value">{{ $invoice->billing_period_start->format('M d, Y') }} - {{ $invoice->billing_period_end->format('M d, Y') }}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="next-steps">
                <h3>What's Next?</h3>
                <ul>
                    <li>Your subscription is now active until {{ $invoice->billing_period_end->format('M d, Y') }}</li>
                    <li>You'll receive an invoice reminder 15 days before your next billing date</li>
                    <li>All features of {{ $plan->name }} are available to your team</li>
                    <li>You can manage your subscription anytime in your account settings</li>
                </ul>
            </div>

            <p style="text-align: center; margin-top: 30px;">
                <a href="{{ config('app.frontend_url') }}/tenant/invoices" style="color: #059669; text-decoration: none; font-weight: 600;">View All Invoices →</a>
            </p>
