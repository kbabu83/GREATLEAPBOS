    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                Your refund was processed on {{ now()->format('M d, Y') }} and will appear in your account within 5-7 business days
            </div>
            ...
            <div class="details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">₹{{ number_format($invoice->amount + $refundAmount, 2) }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Refund Amount</span>
                    <span class="detail-value">₹{{ number_format($refundAmount, 2) }}</span>
                </div>
                <div class="detail-row">
            ...
            <p style="text-align: center; margin-top: 30px;">
                <a href="{{ config('app.frontend_url') }}/tenant/invoices" style="color: #3b82f6; text-decoration: none; font-weight: 600;">View Invoice Details →</a>
            </p>
